(function() {
  function displaySearchResults(results, store, searchTerm) {
    ...
    if (results.length) { // Are there any results?
      var appendString = '<h1 class="text-center">Resultados de la búsqueda para: "'+searchTerm+'"</h1>';
      ...
      for (var i = 0; i < results.length; i++) {  // Iterate over the results
        ...
        appendString += '<p>' + item.content.substr(occurrencePosition , 550) + '...</p></li>';
      }

      searchResults.innerHTML = appendString;
    } else {
      searchResults.innerHTML = '<h1 class="text-center">Resultados de la búsqueda para: "'+searchTerm+'"</h1>';
